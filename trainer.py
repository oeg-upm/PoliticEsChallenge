...
# directories of the dataset to use
train_dataset = 'None'
...
argv = sys.argv
argc = len(argv)
arguments = {"--train_data": "", "--model_name": "", "--labels": [], "--save_model_on_directory": ""}
arguments_stack = ["--train_data", "--model_name", "--labels", "--save_model_on_directory"]
mandatories = ["--train_data", "--model_name"]
i = 1
while i < argc:
    arg = argv[i]
...
def fineTunning(train_data, save_model = False):
...
trainer = fineTunning(df_train, save_model=save_flag)